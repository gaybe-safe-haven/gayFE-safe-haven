...
export default function RateForm({ id, submitReview }) {
  ...
  <form className={styles.review}>
    ...
    <div className={styles.rating}>
      ...
      <input type="range" id="staff" name="staff" min="0" max="10" value={review.staff}/>
    </div>
    ...
    <div className={styles.rating}>
      ...
      <input type="range" id="safety" name="safety" min="0" max="10" value={review.safety}/>
    </div>
    ...
    <div className={styles.rating}>
      ...
      <input type="range" id="clean" name="clean" min="0" max="10" value={review.safety}/>
    </div>
